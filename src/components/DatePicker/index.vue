<template>
    <div
        class="vhd-datepicker__wrapper"
        :class="{
            'vhd-datepicker__wrapper--grid': gridStyle,
            'vhd-datepicker__wrapper--booking': bookings.length > 0,
            datepicker__fullview: alwaysVisible,
        }"
        :ref="`DatePicker-${hash}`"
        v-if="show"
    >
        <div class="vhd-datepicker__close-button -vhd-hide-on-desktop" v-if="isOpen" @click="closeMobileDatepicker">
            <i>+</i>
        </div>
        <div class="vhd-datepicker__dummy-wrapper" :class="{ 'vhd-datepicker__dummy-wrapper--is-active': isOpen }">
            <date-input
                :i18n="i18n"
        ...
        <div
            class="vhd-datepicker__clear-button"
            tabindex="0"
        ...
        <div
            class="vhd-datepicker"
            :class="{
                'vhd-datepicker--open': isOpen && !alwaysVisible,
                'vhd-datepicker--closed': !isOpen && !alwaysVisible,
                'vhd-datepicker--right': positionRight,
            }"
        >
            <div class="-vhd-hide-on-desktop">
                <div
                    v-if="isOpen"
                    class="vhd-datepicker__dummy-wrapper vhd-datepicker__dummy-wrapper--no-border"
                    :class="{ 'vhd-datepicker__dummy-wrapper--is-active': isOpen }"
                    @click="toggleDatepicker"
                >
                    <div
                        class="vhd-datepicker__input"
                        tabindex="0"
                        :class="{
                            'vhd-datepicker__dummy-input--is-active': isOpen && checkIn == null,
                        }"
                        type="button"
                    >
                    ...
                    <div
                        ...
                        tabindex="0"
                        :class="{
                            'vhd-datepicker__dummy-input--is-active': isOpen && checkOut == null && checkIn !== null,
                        }"
                        type="button"
                    >
            ...
            <div v-if="isOpen || alwaysVisible" class="vhd-datepicker__inner">
                <div class="vhd-datepicker__header">
                    <button
                        type="button"
                        class="vhd-datepicker__month-button vhd-datepicker__month-button--prev -vhd-hide-up-to-tablet"
                    ...
                    <button
                        type="button"
                        class="vhd-datepicker__month-button vhd-datepicker__month-button--next -vhd-hide-up-to-tablet"
                ...
                <div
                    class="vhd-datepicker__months"
                    :class="{ 'vhd-datepicker__months--full': showSingleMonth }"
                    v-if="screenSize === 'desktop' || alwaysVisible"
                >
                    <div
                        ref="datepickerMonth"
                        class="vhd-datepicker__month"
                        v-for="(month, monthIndex) in paginateDesktop"
                        :key="`${datepickerMonthKey}-${month}`"
                    >
                        <p class="vhd-datepicker__month-name">
                            {{ getMonth(months[activeMonthIndex + month].days[15].date) }}
                        </p>
                        <div class="vhd-datepicker__week-row -vhd-hide-up-to-tablet">
                            <div
                                class="vhd-datepicker__week-name"
                ...
                <div
                    ...
                    :class="{ 'vhd-show-tooltip': showCustomTooltip && hoveringTooltip }"
                >
                    <div class="vhd-datepicker__tooltip--mobile" v-if="hoveringTooltip">
                        <template v-if="customTooltipMessage">
                            {{ cleanString(customTooltipMessage) }}
                        </template>
                    </div>
                    <div class="vhd-datepicker__week-row">
                        <div
                            class="vhd-datepicker__week-name"
                    ...
                    <div class="vhd-datepicker__months" id="swiperWrapper" ref="swiperWrapper">
                        <div
                            ref="datepickerMonth"
                            class="vhd-datepicker__month"
                            v-for="(a, n) in months"
