<template>
    <div>
        <div
            class="vhd-datepicker__tooltip"
            v-html="tooltipMessageDisplay"
            v-if="showTooltip && options.hoveringTooltip"
        />
        <div
            class="vhd-datepicker__month-day"
            @click.prevent.stop="dayClicked($event, date)"
            :class="[dayClass, checkinCheckoutClass, bookingClass, { 'vhd-datepicker__month-day--today': isToday }]"
            :tabindex="tabIndex"
            ref="day"
        >
            <div class="vhd-datepicker__month-day-wrapper">
                <span>{{ dayNumber }}</span>
    ...
    computed: {
            ...
            if (Object.keys(this.checkIncheckOutHalfDay).length > 0) {
                ...
                if (this.checkIncheckOutHalfDay[keyDate] && this.checkIncheckOutHalfDay[keyDate].checkIn) {
                    if (this.checkIn && !this.checkOut) {
                        return 'vhd-datepicker__month-day--halfCheckIn vhd-datepicker__month-day--valid'
                    }

                    return 'vhd-datepicker__month-day--halfCheckIn vhd-datepicker__month-day--invalid'
                }

                if (this.checkIncheckOutHalfDay[keyDate] && this.checkIncheckOutHalfDay[keyDate].checkOut) {
                    return 'vhd-datepicker__month-day--halfCheckOut vhd-datepicker__month-day--valid'
                }
            }
            ...
            if (this.bookings.length > 0 && this.currentBooking) {
                if (
                    ...
                    if (this.checkIncheckOutHalfDay[this.formatDate]) {
                        if (this.checkIn && !this.checkOut) {
                            return 'vhd-datepicker__month-day--not-allowed vhd-datepicker__month-day--hovering'
                        }
                        ...
                        return 'vhd-datepicker__month-day--not-allowed vhd-datepicker__month-day--invalid'
                    }
        ...
        dayClass() {
            if (this.belongsToThisMonth) {
                ...
                if (
                    ...
                    return 'vhd-datepicker__month-day--valid vhd-datepicker__month-day--disabled vhd-datepicker__month-day--not-allowed vhd-minimumDurationUnvalidDay'
                }
                ...
                if (
                    ...
                    return 'vhd-datepicker__month-day--selected vhd-datepicker__month-day--hovering vhd-currentDay'
                }
                ...
                if (this.checkIn !== null && this.dateFormater(this.checkIn) === this.dateFormater(this.date)) {
                    if (this.minNightCount === 0) {
                        return 'vhd-datepicker__month-day--first-day-selected vhd-checkIn'
                    }

                    // Good
                    return 'vhd-datepicker__month-day--disabled vhd-datepicker__month-day--first-day-selected vhd-checkIn'
                }
                ...
                if (this.checkOut !== null) {
                    if (this.dateFormater(this.checkOut) === this.dateFormater(this.date)) {
                        if (this.halfDayClass) {
                            return `vhd-datepicker__month-day--disabled vhd-datepicker__month-day--last-day-selected ${this.halfDayClass} vhd-checkOut`
                        }

                        return 'vhd-datepicker__month-day--disabled vhd-datepicker__month-day--last-day-selected vhd-checkOut'
                    }
                }
                ...
                if (this.isHighlighted && !this.isDisabled) {
                    if (this.options.disabledDaysOfWeek.some(i => i === fecha.format(this.date, 'dddd'))) {
                        return 'vhd-datepicker__month-day--selected vhd-datepicker__month-day--disabled vhd-afterMinimumDurationValidDay'
                    }
                    ...
                    if (
                        ...
                        if (this.checkInPeriod.minimumDuration === 1) {
                            return 'vhd-datepicker__month-day--selected vhd-afterMinimumDurationValidDay'
                        }
                    ...
                    if (this.checkIn && this.checkOut) {
                        return 'vhd-datepicker__month-day--selected'
                    }
                }
                ...
                if (
                    ...
                    return 'vhd-datepicker__month-day--disabled'
                }
            } else if (!this.belongsToThisMonth) {
                // Good
                return 'vhd-datepicker__month-day--hidden'
            }
            ...
            // Good
            return 'vhd-datepicker__month-day--valid'
        },
        checkinCheckoutClass() {
            ...
            if (
                ...
                return 'vhd-datepicker__month-day--disabled vhd-datepicker__month-day--not-allowed vhd-nightly'
            }
            ...
            if (currentPeriod) {
                ...
                if (
                    ...
                    return 'vhd-datepicker__month-day--disabled vhd-datepicker__month-day--not-allowed vhd-weekly_by_saturday'
                }
                ...
                if (
                    ...
                    return 'vhd-datepicker__month-day--disabled vhd-datepicker__month-day--not-allowed vhd-weekly_by_sunday'
                }
